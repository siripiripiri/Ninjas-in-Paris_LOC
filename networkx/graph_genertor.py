...
def get_news_articles(keywords, financial_domains="finance",language="en"):
  """
...
# Add nodes and edges to the network graph
  ...
  script_dir = os.path.dirname(__file__)  # Directory of the current scriptoutput_folder = os.path.join(script_dir, '..', 'javachips')  # Assuming your website code is one directory above the current directoryoutput_file = os.path.join(output_folder, 'graph.html')
# Create the output folder if it doesn't existos.makedirs(output_folder, exist_ok=True)
